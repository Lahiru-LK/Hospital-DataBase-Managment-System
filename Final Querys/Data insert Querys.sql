-- Data insert for Medicine table
...
-- Data insert for Department_Lab table
...
-- Data insert for Ward_boy_Assign table
...
-- Data insert for Nurse_Assign table
...
-- Data insert for Pharmacy table
...
-- Data insert for Laboratory table
...
-- Data insert for Department table
...
-- Data insert for Payment_Method table
...
-- Data insert for Ward_boy table
...
-- Data insert for Patient_Contact table
...
-- Data insert for Inpatient table
...
-- Data insert for Outpatient table
...
-- Data insert for Doctor_treat table
...
SELECT * FROM Doctor;
SELECT * FROM Family;
SELECT * FROM Ward_boy_Assign;
SELECT * FROM Nurse_Assign;
SELECT * FROM Patient;
SELECT * FROM Record;
SELECT * FROM Bill;
